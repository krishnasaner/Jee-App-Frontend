...
const chapters = [
  {
    ...
    title: "Sets",
    progress: 0.75,
    icon: require("../assets/icon/icon_7.png"),
  },
  {
    id: 2,
    title: "Relation and Functions",
    icon: require("../assets/icon/icon_(1).png"),
  },
  {
    id: 3,
    title: "Trignometric Function",
    icon: require("../assets/icon/icon_(2).png"),
  },
  {
    id: 4,
    title: "Principal Of Mathematical Induction",
    icon: require("../assets/icon/icon_(3).png"),
  },
  {
    id: 5,
    title: "Complex Number and Quadritic Equation",
    icon: require("../assets/icon/icon_(4).png"),
  },
  {
    id: 6,
    title: "Linear inequilities",
    icon: require("../assets/icon/icon_(5).png"),
  },
  {
    id: 7,
    title: "Permutation and Combination",
    icon: require("../assets/icon/icon_(6).png"),
  },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCard}>
          <Image source={require("../assets/icon/Rectangle_(3).png")} style={styles.headerImage} />
