...
const chapters = [
  {
    ...
    progress: 0.75,
    icon: require("./assets/icons/ch1.png"),
  },
  {
    id: 2,
    title: "Motion in a Straight Line",
    icon: require("./assets/icons/ch2.png"),
  },
  {
    id: 3,
    title: "Motion in a Plane",
    icon: require("./assets/icons/ch3.png"),
  },
  {
    id: 4,
    title: "Laws of Motion",
    icon: require("./assets/icons/ch4.png"),
  },
  {
    id: 5,
    title: "Work, Energy and Power",
    icon: require("./assets/icons/ch5.png"),
  },
  {
    id: 6,
    title: "System of Particles and Rotational..",
    icon: require("./assets/icons/ch6.png"),
  },
  {
    id: 7,
    title: "Gravitation",
    icon: require("./assets/icons/ch7.png"),
  },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCard}>
          <Image source={require("./assets/icons/headerpy.png")} style={styles.headerImage} />
