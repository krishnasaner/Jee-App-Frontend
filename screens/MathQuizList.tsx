    ...
    <SafeAreaView style={styles.root}>
      ...
      <View style={styles.headerContent}>
        <View style={styles.breadcrumbRow}>
          ...
          <Text style={styles.bcText}>Mathematics</Text>
          <Text style={styles.bcText}> &gt; </Text>
        ...
        <View style={[styles.subjectCard, { marginTop: scale(30) }]}>
          <View style={styles.leftIconBox}>
            <Image source={require('../assets/images/LinearEqualities.png')} style={styles.iconImage} resizeMode="contain" />
          </View>
          <Text style={styles.subjectTitle}>Linear Inequalities</Text>
        </View>
      </View>
